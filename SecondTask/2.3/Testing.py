...
class UserInput:
    ...
    """
    def __init__(self, file_name: str = "vacancies_by_year.csv", profession: str = "Аналитик"):
        """
        ...
        >>> up.profession
        'Аналитик'
        >>> up = UserInput("vacancies.csv", "Программист")
        >>> up.file_name
        'vacancies.csv'
        >>> up.profession
        'Программист'
...
class Salary:
    ...
    salary_currency : str
        Валюта оклада
    average_salary_rur: int
        Средняя зарплата в рублях, вычисляется по нижней и верхней границе
    ...
    def __init__(self, salary_from: str = None, salary_to: str = None, salary_currency: str = None):
        """
        ...
        7
        >>> salary.average_salary_rur
        449
        """
        self.salary_from = salary_from
        self.salary_to = salary_to
        self.salary_currency = salary_currency
        self.set_average_salary()
    ...
    def set_average_salary(self):
        ...
        """
        if self.salary_currency is None or self.salary_from is None or self.salary_to is None:
            return

        self.average_salary = int((float(self.salary_from) + float(self.salary_to)) // 2)
        self.average_salary_rur = int(self.currency_to_rub[self.salary_currency] *
...
class Vacancy:
    ...
    def __init__(self, fields: dict):
        ...
        >>> vacancy = Vacancy({"name": "Аналитик"})
        >>> vacancy.name
        'Аналитик'
        >>> hasattr(vacancy, "employer_name")
        False
        """
        self.date_time_publishing = None
        for key, value in fields.items():
            value = delete_html_tags(value)
    ...
    def published_time_formatter(self):
        ...
        published_at
        >>> vacancy = Vacancy({"published_at": '2023-01-01T10:00:00+00'})
        >>> vacancy.published_at == 2023
        True
        >>> vacancy.date_time_publishing == datetime(2023, 1, 1, 10, 0)
        True
        """
    ...
    def get_field(self, field: str):
        ...
        """
        if field == 'salary':
            return self.salary.average_salary_rur
...
class DataDictionary:
    ...
    def update_salary_dict(self, dict_name: str, field: str, vac: Vacancy) -> None:
        ...
        if key not in dictionary.keys():
            dictionary[key] = [vac.salary.average_salary_rur, 1]
        else:
            dictionary[key][0] += vac.salary.average_salary_rur
            dictionary[key][1] += 1
...
def delete_html_tags(value: str) -> str:
    """
    Удаляет html теги
    :param value: строка с тегами
    :return: строка без тегов

    >>> delete_html_tags('<a></a><p></p>') == ''
    True
    """
